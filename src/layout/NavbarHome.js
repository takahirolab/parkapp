        ...
        return (
            ...
            <>
                ...
                /////////////////////// */}
                    ...
                    <p onClick={this.openModalLogin} className="nav-item_login nav-itemlogin__shadow" style={
                            this.state.currentPosition >170 ? { color: '#424242',textShadow:'none'} :  { color: '#fff' ,transition:'0.1s'}
                        }>ログイン</p>
