    ...
    render() {
        ...
        return (
            ...
            {/* <div className="home-maincontent_inner">
                ...
                <ul className="home-maincontent-items">
                  <Link to={{ pathname: "/park/search", state: { parkTag: '芝生がある広い公園' } }}class="parkcategory-show__item white category-show__img1"　style={{ background: `linear-gradient(to bottom, rgb(255 255 255 / 0%) 0%, rgb(0 0 0 / 23%) 100%),url(${Grass})`,backgroundSize:'Cover'}} onClick={this.handleGetLatAndLng}><p class="white">芝生がある広い公園</p></Link>
                  <Link to={{ pathname: "/park/search", state: { parkTag: '国立公園' } }} class="parkcategory-show__item white category-show__img2" style={{ background: `linear-gradient(to bottom, rgb(255 255 255 / 0%) 0%, rgb(0 0 0 / 23%) 100%),url(${nationalPark})`,backgroundSize:'Cover'}}><p class="white">国立公園</p></Link>
                  <Link to={{ pathname: "/park/search", state: { parkTag: 'キャンプができる公園' } }}class="parkcategory-show__item white category-show__img3" style={{ background: `linear-gradient(to bottom, rgb(255 255 255 / 0%) 0%, rgb(0 0 0 / 23%) 100%),url(${Camp})`,backgroundSize:'Cover'}}><p class="white">キャンプができる公園</p></Link>
                  <Link to={{ pathname: "/park/search", state: { parkTag: '海がみえる公園' } }} class="parkcategory-show__item white category-show__img4" style={{ background: `linear-gradient(to bottom, rgb(255 255 255 / 0%) 0%, rgb(0 0 0 / 23%) 100%),url(${boatParkr})`,backgroundSize:'Cover'}}><p class="white">海がみえる公園</p></Link>
                  <Link to={{ pathname: "/park/search", state: { parkTag: '博物館・資料館がある公園' } }} class="parkcategory-show__item white category-show__img5" style={{ background: `linear-gradient(to bottom, rgb(255 255 255 / 0%) 0%, rgb(0 0 0 / 23%) 100%),url(${NightPic})`,backgroundSize:'Cover'}}><p class="white">博物館・資料館がある公園</p></Link>
                  <Link to={{ pathname: "/park/search", state: { parkTag: '動植物を観察できる公園' } }} class="parkcategory-show__item white category-show__img5" style={{ background: `linear-gradient(to bottom, rgb(255 255 255 / 0%) 0%, rgb(0 0 0 / 23%) 100%),url(${animal})`,backgroundSize:'Cover'}}><p class="white">動植物を観察できる公園</p></Link>
              </ul>
              <ul className="sidebar-items">
